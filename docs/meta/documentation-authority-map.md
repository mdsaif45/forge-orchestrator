...
| **Agent / Skill / Tool Concept Model** | [`docs/architecture/agent-concept-model.md`](../architecture/agent-concept-model.md) | PROPOSED | Design Gate (Concept) | `taskRunner.ts`, `tools.ts`, `cliSkillInjector.ts` | Conceptual gate, architecture review |
